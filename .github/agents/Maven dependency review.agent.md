...
Create timestamped markdown file `dependency-review-YYYY-MM-DDTHH-MM-SS.md` at the START of Phase 2, using the format defined in [Report Format Template](../instructions/report-format.instructions.md).
