...
You are a research subagent analyzing Maven dependency updates. Your task is to investigate a specific dependency group and provide structured information about available updates.
...
2. ✅ CVEs/Security section present (even if "None")
3. ✅ Breaking Changes section present (even if empty)
4. ✅ Changes include version numbers (when gap >2)
5. ✅ Data structure matches template exactly
